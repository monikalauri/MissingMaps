---
layout: hot-tasking-manager
title: "HOT Tasking Mananger"
permalink: "/hot-tasking-manager/"
description: |-
...
fs_step1_title: "1. Create an OpenStreetMap and Tasking Manager account"
fs_step1_video_id: "suk8uRpIBQw"
fs_step1_body: |-
  Go to the Humanitarian OpenStreetMap Team’s [Tasking Manager website](https://tasks.hotosm.org/) to create an account.  
  Follow the link in the email they send to confirm your account.

fs_step2_title: "2. Learn to use the Tasking Manager"
fs_step2_video_id: "wqQdDgjBOvY"
fs_step2_body: |-
...
fs_step3_title: "3. Learn to map buildings"
fs_step3_video_id: "nswUcgMfKTM"
fs_step3_body: |-
...
fs_step4_title: "4. Learn to map roads"
fs_step4_video_id: "NzZWur1YG1k"
fs_step4_body: |-
...
fs_guide_button_text: "HOT Learning Guide"
fs_guide_button_url: "https://tasks.hotosm.org/learn/map"

fs_start_mapping_heading: "Start Mapping"
fs_start_mapping_text: "Ready to try it yourself?"
fs_start_mapping_button_url: "https://tasks.hotosm.org/explore?omitMapResults=1&action=map"
fs_start_mapping_button_text: "Map Now"
fs_start_mapping_image: "assets/images/pages/Training-Materials-(backup).jpg"
fs_start_mapping_image_credit: "Edgar Lima / MSF"

fs_more_training_heading: "More Training Resources"
fs_more_training_intro: |-
  If you’re interested in a more detailed training, check out these webinars:

fs_webinar_1_title: "Tasking Manager Walkthrough"
fs_webinar_1_video_id: "XMtpZf9RoMc"
fs_webinar_2_title: "Tasking Manager Walkthrough"
fs_webinar_2_video_id: "LCVaju6d6lI"
fs_webinar_playlist_id: "PLb9506_-6FMFhgnFqmOVCBCWIGP2SHAwF"
...
advanced_intro: |-
  ...
  First, you’ll need to download the application. You can do that [here](https://josm.openstreetmap.de/wiki/Download).  
...
advanced_webinar_1_title: "Beginner JOSM"
advanced_webinar_1_video_id: "ybKKJHX9rms"

advanced_webinar_2_title: "Advanced JOSM"
advanced_webinar_2_video_id: "98kd1kJ5mKQ"
...
validation_be_validator_heading: "Be a validator"

validation_step1_title: "1. Identify if becoming a validator is right for you."
validation_step1_body: |-
  ...
  Check out our [Validation FAQs](https://github.com/MissingMaps/missing-maps-website/blob/main/assets/downloads/en/MissingMaps_validation_faq_en.pdf) to gain some insight on what validating entails.

validation_step2_title: "2. Build your skills."
validation_step2_body: |-
  Becoming a more efficient mapper is crucial to becoming a validator. The [JOSM Editor](https://josm.openstreetmap.de/) is a customizable editor for OpenStreetMap with a number of tools and plugins to make mapping and validating easier!  

  Check out this guide to validation using the JOSM editor. For instruction setting up JOSM, you can also head over to [LearnOSM](https://learnosm.org/en/josm/).

validation_step2_note: |-
...
validation_webinar_intro: "Watch this HOT Training webinar for Introduction into validation:"
validation_webinar_video_id: "oH4Q18nBT68"

validation_step3_title: "3. Collaborate as part of the broader community."
validation_step3_body: |-
  The best way to get in touch with other validators and the humanitarian mapping community is joining the [HOTOSM Slack](http://slack.hotosm.org/).  
...
validation_resources_heading: "Resources:"
validation_resources_body: |- 
  - [LearnOSM validation page](https://learnosm.org/en/coordination/validation/)  
  - [Wiki for validating tasks on Tasking Manager](https://wiki.openstreetmap.org/wiki/Tasking_Manager/Validating_data)  
