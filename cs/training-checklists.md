...
- **[Loga Missing Maps](https://drive.google.com/drive/folders/1y-PJ3MoHndFtm_Xcm_7qPMjtNYxbygCs)**: Získejte oficiální logo v běžných formátech nebo použijte přizpůsobitelnou verzi pro vaši komunitu.

- **[Rychlý průvodce](https://tasks.hotosm.org/learn/quickstart) pro HOT Tasking Manager**: Naučte se pracovat s Tasking Managerem a efektivně vést účastníky.

Užijte si mapování a propojení s komunitou!
