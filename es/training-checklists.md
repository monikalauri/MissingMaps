...
description: |-
  ¡Explora todo lo que necesitas para organizar un evento exitoso de Missing Maps!
...
- **[Logotipos de Missing Maps](https://drive.google.com/drive/folders/1y-PJ3MoHndFtm_Xcm_7qPMjtNYxbygCs)**: Accede al logotipo oficial en formatos comunes o utiliza la versión personalizable para tu comunidad.

- **[Guía de inicio rápido](https://tasks.hotosm.org/learn/quickstart) del HOT Tasking Manager**: Aprende a usar el Tasking Manager y a guiar eficazmente a las personas participantes.

¡Disfruta mapeando y conectando con la comunidad!
